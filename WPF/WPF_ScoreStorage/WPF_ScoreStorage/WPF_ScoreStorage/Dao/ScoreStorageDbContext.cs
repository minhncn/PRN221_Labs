...
{
    public partial class ScoreStorageDbContext : DbContext
    {
        public ScoreStorageDbContext()
        {
        }

        public ScoreStorageDbContext(DbContextOptions<ScoreStorageDbContext> options)
            : base(options)
        {
        }
